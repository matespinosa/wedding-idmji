...
import { ArrowUpRight, BookOpen, CalendarPlus, Clock, MapPin } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-1 flex-col p-8 md:p-10">
        ...
        <p className="mt-6 text-[12px] font-medium uppercase tracking-[0.28em] text-bronze">
          {site.date.long}
        </p>

        <h3 className="mt-3 font-serif text-[1.95rem] font-light leading-tight text-ink md:text-[2.2rem]">
          {venue.name}
        </h3>
        ...
        <div className="mt-auto">
          ...
          <p className="mb-7 text-[17px] leading-relaxed text-ink/55">
            {site.venues.arrival}
          </p>
  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto max-w-5xl px-5 md:px-8">
        ...
        {/* Una sola tarjeta: la ceremonia es todo el evento. Va centrada y
            a media caja para que no se estire a lo ancho del contenedor. */}
